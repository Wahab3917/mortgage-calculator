...
function computeResults(e) {
  ...
  //Show results
  document.getElementById("monthlyPayment").innerHTML = "$" + monthlyPayment + "  Monthly Payments";
  document.getElementById("totalInterest").innerHTML = "%" + totalInterest + "  Total Interest";
  document.getElementById("totalPayment").innerHTML = "$" + totalPayment + "  Total Payment";
